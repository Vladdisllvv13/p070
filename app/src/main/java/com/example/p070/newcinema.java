...
public class newcinema extends AppCompatActivity {
    ...
    EditText tvName;
    newcinema.MyTask mt;
    newcinema.MyTaskN mtn;
    newcinema.MyTaskTF mttf;
    ListView lvMain;
    //    String ID;
    @Override
...
//                        sb.append("\r\n : " +value);
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            super.onPostExecute(result);
            newcinema.ClAdapter adapter3=new newcinema.ClAdapter(tvInfo.getContext(),result);
//            lvMain = (ListView) findViewById(R.id.lvMain);
